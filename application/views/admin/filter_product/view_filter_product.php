 	 ...
 	 <th>name</th>
        ...
        <tbody>
        <?php $i=1; foreach($filter_product_data->result() as $data) { ?>
        <tr>
        <td><?php echo $i ?> </td>
 	 ...
 	 <td><?php echo $data->name ?></td>
        ...
        <li><a href="<?php echo base_url() ?>dcadmin/Filter_product/updatefilter_productStatus/<?php echo
        base64_encode($data->id) ?>/inactive">Inactive</a></li>
        <?php } else { ?>
        <li><a href="<?php echo base_url() ?>dcadmin/Filter_product/updatefilter_productStatus/<?php echo
        base64_encode($data->id) ?>/active">Active</a></li>
        <?php } ?>
        <li><a href="<?php echo base_url() ?>dcadmin/Filter_product/update_filter_product/<?php echo
        ...
        <a href="<?php echo base_url() ?>dcadmin/Filter_product/delete_filter_product/<?php echo
