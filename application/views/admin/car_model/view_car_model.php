        ...
        <h3 class="panel-title"><i class="fa fa-money fa-fw"></i>View car model</h3>
        </div>
        <div class="panel panel-default">
 	 ...
 	 <td><?php echo $data->name ?></td>
        ...
        <li><a href="<?php echo base_url() ?>dcadmin/Car_model/updatecar_modelStatus/<?php echo
        base64_encode($data->id) ?>/inactive">Inactive</a></li>
        <?php } else { ?>
        <li><a href="<?php echo base_url() ?>dcadmin/Car_model/updatecar_modelStatus/<?php echo
        base64_encode($data->id) ?>/active">Active</a></li>
        <?php } ?>
        <li><a href="<?php echo base_url() ?>dcadmin/Car_model/update_car_model/<?php echo
        ...
        <a href="<?php echo base_url() ?>dcadmin/Car_model/delete_car_model/<?php echo
